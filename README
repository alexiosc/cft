...
* The [Microcode
  Assembler](https://www.bedroomlan.org/projects/mcasm/), also
  available on Github as https://github.com/alexiosc/mcasm.
...
* Too many emulators to speak of!
	...
	** A [Javascript microcode-level
    emulator](https://www.bedroomlan.org/hardware/cft/microcode-emulator/)
	...
	** A newer JS-based emulator meant to me much faster. Still
    ...
    testing.
* A testing framework that can run test suites on any emulator we can
  use.
