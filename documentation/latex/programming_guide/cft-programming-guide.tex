...
\begin{figure}[tb]
  ...
  \begin{tikzpicture}
    ...
    \newcommand\xxregflag[2]{%
      \begin{scope}[#1]
        \draw[line width=2pt](0,0) rectangle (0.4,0.6);
        \draw (0.2,0.3) node {#2};
        \draw (0.4,0) node[below] { \footnotesize 0 };
    ...
    \begin{scope}[yshift=-6cm]
      \xxregflag{xshift=7.6cm}{\Ireg}
      \xxregflag{xshift=6.8cm}{\Vreg}
      \xxregflag{xshift=6.0cm}{\Zreg}
      \xxregflag{xshift=5.2cm}{\Nreg}
      \xxregflag{xshift=4.4cm}{\Lreg}
    \end{scope}
  \end{tikzpicture}
