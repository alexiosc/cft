...
\begin{longtable}{llcP{0.42\textwidth}}
  ...
  {\ttfamily 0110 1 0 0000000000 (6400) } & {\ttfamily RET}      & 11      & Return from subroutine. \macro{RET I R 0} \\
  {\ttfamily 0110 1 0 0000000001 (6401) } & {\ttfamily RTT}      & 11      & Return from trap. \macro{RET I R 1} \\
  ...
  %
  {\ttfamily 1111 - R aaaaaaaaaa (F000) } & {\ttfamily LIA a }   & 4       & Load immediate address: $\aeq\val$ (\barecf{sec:instruction-LIA}) \\
  {\ttfamily 1111 - 0 aaaaaaaaaa (F000) } & {\ttfamily LI a }    & 4       & Load immediate. \macro{LI R} \\
