...
\begin{tikzpicture}%
  ...
  \begin{scope}[,yshift=-3cm]
    \TargetRegisterTwo{Page-relative address}{above right}{\AR}{col14!50}{col10!50}
  \end{scope}

  % The Accumulator
  \begin{scope}[,yshift=-4.5cm]
    \TargetRegister{Address}{above right}{\PC}{col8!33}
  \end{scope}
