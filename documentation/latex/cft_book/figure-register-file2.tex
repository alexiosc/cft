...
\begin{tikzpicture}%
    ...
    \newcommand\xxregfile[3]{%
      \begin{scope}[#1]
        \draw[line width=0pt,fill=#2](0,0) rectangle (8,0.6);
    ...
    \xxregfile{}{\A}
    \xxregfile{yshift=-1.2cm}{p1}{\PC}
    \xxregfile{yshift=-2.4cm}{p2}{\DR}
    \xxregfile{yshift=-3.6cm}{p3}{\IR}
    \xxregfile{yshift=-4.8cm}{p4}{\AR}
