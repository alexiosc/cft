...
\li{\ns{CLL}} (Port 1, pin 1) A direct output from the Microcode board, this
active low strobe clears the \Lreg~register on the falling edge.

\li{\ns{CPL}} (Port 1, pin 3) A direct output from the Microcode board. While
\sn{CPL} is low, the \Lreg~register is complemented (toggled) on every falling
edge of \ps{CLK3}.
