...
\begin{table}[t]
%%% RESTORE THIS: \caption{\label{table-control-pinout}Control Bus Pin-out.}
\vspace{1em}
\centering
\zebra
...
\begin{table}[t!]
%%% RESTORE THIS: \caption[Expansion Bus Pin out]{\label{table-expansion-pinout}Expansion Bus Pin-out. Row B is
