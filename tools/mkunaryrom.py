        ...
        for op in xrange(8):
            for l in xrange(2):
                for a in xrange(self.a0, self.a1 + 1):
                    ...
                    addr = tt.make_vector(tt.inputs, op=op, l=l, a=a)
...
unaryROM = romtables.FunctionTable('op:3 l a:16', 'is_roll l x:16')
unaryROM.rom('op l a/15,14,13,9,8,7,6,5,4,3,2,1,0', 'x/5-0')
unaryROM.rom('op a/15,14,13,12,11,10,9,8,7,6,5,4,3,2', 'x/11-6')
unaryROM.rom('op l a/15,14,13,12,11,10,9,8,3,2,1,0', 'is_roll l x/15-12')
