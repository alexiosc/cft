...
$EndDescr
Wire Wire Line
	21650 3800 22350 3800
Wire Wire Line
	23050 3700 23050 4200
Wire Wire Line
	22950 4000 22950 4300
Wire Wire Line
	23050 4200 23100 4200
Wire Wire Line
	22950 4300 23100 4300
Wire Wire Line
	22850 3700 23050 3700
Wire Wire Line
	22850 4000 22950 4000
$Comp
...
F 0 "U45" H 23475 4614 50  0000 C CNN
F 1 "74LVC1G0832" H 23475 4523 50  0000 C CNN
F 2 "alexios:SOT-23-6_Handsoldering" H 23450 4300 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/sn74lvc1g0832.pdf" H 23450 4300 50  0001 C CNN
	1    23450 4300
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "U42" H 22700 3750 50  0000 C CNN
F 1 "74LVC1G11" H 22450 3650 50  0000 L CNN
F 2 "alexios:SOT-23-6_Handsoldering" H 22550 3875 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/74LVC1G11.pdf" H 22550 3875 50  0001 C CNN
	1    22650 3950
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "U41" H 22700 3850 50  0000 C CNN
F 1 "74LVC1G11" H 22850 3750 50  0000 C CNN
F 2 "alexios:SOT-23-6_Handsoldering" H 22550 3575 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/74LVC1G11.pdf" H 22550 3575 50  0001 C CNN
	1    22650 3650
	1    0    0    -1  
$EndComp
Text Label 21650 3900 0    50   ~ 0
IR9
Text Label 21650 3800 0    50   ~ 0
IR8
Wire Wire Line
	22350 3900 21650 3900
Text Label 21650 4000 0    50   ~ 0
IR10
Wire Wire Line
	22350 4000 21650 4000
Text Label 21650 4100 0    50   ~ 0
IR11
Wire Wire Line
	22350 4100 21650 4100
Text Label 21650 3700 0    50   ~ 0
WADDR1
Wire Wire Line
	21650 3700 22350 3700
Text Label 21650 3600 0    50   ~ 0
WADDR0
Wire Wire Line
	21650 3600 22350 3600
Wire Wire Line
	23850 4300 23900 4300
Wire Wire Line
	23900 4300 23900 4400
Wire Wire Line
	23900 4400 23950 4400
$Comp
...
F 0 "U46" H 24175 4717 50  0000 C CNN
F 1 "74LVC1G08" H 24175 4626 50  0000 C CNN
F 2 "alexios:SOT-23-5_HandSoldering" H 23900 4450 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/74LVC1G08.pdf" H 23900 4450 50  0001 C CNN
	1    24250 4450
	1    0    0    -1  
$EndComp
Wire Wire Line
	23950 4500 21650 4500
Wire Wire Line
	5050 3200 6700 3200
$Comp
...
U 1 1 5E1BB508
P 22550 2300
F 0 "U?" H 22600 2567 50  0000 C CNN
F 1 "74LVC1G32" H 22600 2476 50  0000 C CNN
F 2 "" H 22660 2280 50  0001 C CNN
F 3 "http://www.ti.com/lit/sg/scyt129e/scyt129e.pdf" H 22660 2280 50  0001 C CNN
	1    22550 2300
	1    0    0    -1  
$EndComp
...
Wire Wire Line
	5050 3200 5050 3650
Wire Wire Line
	24400 4450 24750 4450
Text Label 24750 4450 2    50   ~ 0
~USE-IR
Wire Wire Line
	23100 4400 21650 4400
$Comp
L alexios:74LVC1G08 U?
U 1 1 5E5E8BA8
P 22650 4900
...
F 0 "U?" H 22575 5167 50  0000 C CNN
F 1 "74LVC1G08" H 22575 5076 50  0000 C CNN
F 2 "alexios:SOT-23-5_HandSoldering" H 22300 4900 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/74LVC1G08.pdf" H 22300 4900 50  0001 C CNN
	1    22650 4900
	1    0    0    -1  
$EndComp
...
~READ-MBP
Wire Wire Line
	22350 4950 21650 4950
Wire Wire Line
	22350 4850 21650 4850
Wire Wire Line
	24750 4900 22800 4900
Text Label 24750 4900 2    50   ~ 0
~USE-MBP
Wire Wire Line
	22350 2600 21650 2600
Text Label 21650 2600 0    50   ~ 0
~WRITE-MBx-AR
Wire Wire Line
	22350 2500 21650 2500
Text Label 21650 2500 0    50   ~ 0
~WRITE-MBn
Wire Wire Line
	23650 2200 22900 2200
Text Label 22900 2200 0    50   ~ 0
~WRITE-MBP+FLAGS
Wire Wire Line
	23650 2100 22900 2100
Text Label 22900 2100 0    50   ~ 0
~WRITE-MBP
Wire Wire Line
	23650 1550 22900 1550
Wire Wire Line
	23650 1650 22900 1650
Wire Wire Line
	23650 1750 22900 1750
Wire Wire Line
	23650 1850 22850 1850
Text Label 22900 1550 0    50   ~ 0
~READ-MBP
Text Label 22900 1650 0    50   ~ 0
~READ-MBP+FLAGS
Text Label 22900 1750 0    50   ~ 0
~READ-MBn
Text Label 22900 1850 0    50   ~ 0
~IN-MBR
$Comp
L alexios:74LVC1G08 U?
U 1 1 5E6B05F4
...
F 0 "U?" H 22575 2375 50  0000 C CNN
F 1 "74LVC1G08" H 22575 2284 50  0000 C CNN
F 2 "alexios:SOT-23-5_HandSoldering" H 22300 2550 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/74LVC1G08.pdf" H 22300 2550 50  0001 C CNN
	1    22650 2550
	1    0    0    -1  
$EndComp
Text Label 24750 2250 2    50   ~ 0
~WMBR
Wire Wire Line
	22850 2300 23650 2300
Wire Wire Line
	22350 2250 21650 2250
Wire Wire Line
	22350 2350 21650 2350
Text Label 21650 2250 0    50   ~ 0
~W
Text Label 21650 2350 0    50   ~ 0
~IOMBR
$Comp
L alexios:74LVC1G32 U?
U 1 1 5E1BC971
P 22550 1850
F 0 "U?" H 22600 2117 50  0000 C CNN
F 1 "74LVC1G32" H 22600 2026 50  0000 C CNN
F 2 "" H 22660 1830 50  0001 C CNN
F 3 "http://www.ti.com/lit/sg/scyt129e/scyt129e.pdf" H 22660 1830 50  0001 C CNN
	1    22550 1850
	1    0    0    -1  
$EndComp
Wire Wire Line
	22350 1800 21650 1800
Wire Wire Line
	22350 1900 21650 1900
Text Label 21650 1900 0    50   ~ 0
~IOMBR
Text Label 21650 1800 0    50   ~ 0
~R
Wire Wire Line
	22800 2550 22850 2550
Wire Wire Line
	22850 2400 23650 2400
Wire Wire Line
	22850 2400 22850 2550
Text Label 22900 2300 0    50   ~ 0
~OUT-MBR
Wire Wire Line
	24250 2250 24750 2250
$Comp
L alexios:74AC21 U?
U 2 1 5E64ADF8
P 23950 2250
F 0 "U?" H 23950 2001 50  0000 C CNN
F 1 "74AC21" H 23950 1910 50  0000 C CNN
...
U 1 1 5E64A96A
P 23950 1700
F 0 "U?" H 23950 2075 50  0000 C CNN
F 1 "74AC21" H 23950 1984 50  0000 C CNN
F 2 "" H 23950 1700 50  0001 C CNN
F 3 "" H 23950 1700 50  0001 C CNN
	1    23950 1700
	1    0    0    -1  
$EndComp
Text Notes 24350 2400 0    50   ~ 0
OR with ~WSTB~?
Text Label 24750 1700 2    50   ~ 0
~RMBR
Wire Wire Line
