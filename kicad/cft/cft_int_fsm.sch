...
AR Path="/5F67D4B5/5F68A0E8" Ref="C802"  Part="1" 
F 0 "C802" H 1109 7146 50  0000 R CNN
...
U 1 1 5F68A2D6
P 1200 7000
F 0 "#PWR0803" H 1200 6850 50  0001 C CNN
...
U 1 1 5F68A4B4
P 1200 7200
F 0 "#PWR0804" H 1200 6950 50  0001 C CNN
...
AR Path="/5F67D4B5/5F6B4251" Ref="C804"  Part="1" 
F 0 "C804" H 2559 7146 50  0000 R CNN
...
U 1 1 5F6B47C5
P 2650 7000
F 0 "#PWR0807" H 2650 6850 50  0001 C CNN
...
U 1 1 5F6B4C91
P 2650 7200
F 0 "#PWR0808" H 2650 6950 50  0001 C CNN
...
AR Path="/5F67D4B5/5F707BE7" Ref="C805"  Part="1" 
F 0 "C805" H 4009 7146 50  0000 R CNN
...
U 1 1 5F7083B1
P 4100 7000
F 0 "#PWR0810" H 4100 6850 50  0001 C CNN
...
U 1 1 5F708D3E
P 4100 7200
F 0 "#PWR0811" H 4100 6950 50  0001 C CNN
...
AR Path="/5F67D4B5/5F85ED41" Ref="C801"  Part="1" 
F 0 "C801" H 1109 6396 50  0000 R CNN
...
U 1 1 5F85F21B
P 1200 6250
F 0 "#PWR0801" H 1200 6100 50  0001 C CNN
...
U 1 1 5F85F700
P 1200 6450
F 0 "#PWR0802" H 1200 6200 50  0001 C CNN
...
U 1 1 5F9349A9
P 7600 3150
F 0 "TP804" V 7600 3338 50  0000 L CNN
...
U 1 1 5D12B3FF
P 5750 1800
F 0 "TP801" V 5750 1988 50  0000 L CNN
...
Wire Wire Line
	6350 3050 6700 3050
$Comp
L alexios:74LVC1G08 U802
U 1 1 5D183FAB
P 3300 1800
F 0 "U802" H 3225 1625 50  0000 C CNN
...
U 1 1 5D18C9E4
P 4800 1600
F 0 "#PWR0812" H 4800 1450 50  0001 C CNN
...
U 1 1 5D1C8231
P 6700 3150
F 0 "#PWR0815" H 6700 3000 50  0001 C CNN
...
U 1 1 5D216290
P 4800 5050
F 0 "#PWR0814" H 4800 4900 50  0001 C CNN
...
U 1 1 5D2F6551
P 6750 4950
F 0 "#PWR0816" H 6750 4800 50  0001 C CNN
...
U 1 1 5D388553
P 5750 5250
F 0 "TP803" V 5750 5438 50  0000 L CNN
...
AR Path="/5F67D4B5/5D4C3580" Ref="R801"  Part="1" 
F 0 "R801" H 3009 2846 50  0000 L CNN
...
U 1 1 5D4D2882
P 2950 2700
F 0 "#PWR0809" H 2950 2550 50  0001 C CNN
...
Wire Wire Line
	2200 4600 3000 4600
$Comp
L alexios:74LVC1G32 U804
U 1 1 5D5A4DFA
P 3200 4550
F 0 "U804" H 3250 4817 50  0000 C CNN
...
U 2 1 5D5F45BD
P 1650 6250
F 0 "U802" H 1730 6196 50  0000 L CNN
...
U 2 1 5D5F462B
P 3050 6100
F 0 "U804" H 3180 5896 50  0000 L CNN
...
AR Path="/5F67D4B5/5D5F498A" Ref="C803"  Part="1" 
F 0 "C803" H 2559 6396 50  0000 R CNN
...
U 1 1 5D5F4991
P 2650 6250
F 0 "#PWR0805" H 2650 6100 50  0001 C CNN
...
U 1 1 5D5F4997
P 2650 6450
F 0 "#PWR0806" H 2650 6200 50  0001 C CNN
...
AR Path="/5F67D4B5/5DE59283" Ref="R802"  Part="1" 
F 0 "R802" V 8654 5250 50  0000 C CNN
