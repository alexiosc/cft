...
U 1 1 60833425
P -1650 3500
F 0 "U24" H -1650 3742 50  0000 C CNN
F 1 "AMS1117-3.3" H -1650 3651 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-223-3_TabPin2" H -1650 3700 50  0001 C CNN
F 3 "http://www.advanced-monolithic.com/pdf/ds1117.pdf" H -1550 3250 50  0001 C CNN
	1    -1650 3500
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 1 "GND" H -1645 3727 50  0000 C CNN
...
F 1 "+5V" H -1985 3523 50  0000 C CNN
...
U 1 1 60BB5BFC
P -1650 5350
F 0 "U?" H -1650 6367 50  0000 C CNN
F 1 "PCA9564" H -1650 6276 50  0000 C CNN
F 2 "" H -1650 5350 50  0001 C CNN
F 3 "https://www.nxp.com/docs/en/data-sheet/PCA9564.pdf" H -1650 5350 50  0001 C CNN
	1    -1650 5350
	1    0    0    -1  
$EndComp
$Comp
...
U 2 1 60BDC4A0
P -1600 6800
F 0 "U?" H -1420 6846 50  0000 L CNN
F 1 "PCA9564" H -1420 6755 50  0000 L CNN
F 2 "" H -1600 6800 50  0001 C CNN
F 3 "https://www.nxp.com/docs/en/data-sheet/PCA9564.pdf" H -1600 6800 50  0001 C CNN
	2    -1600 6800
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 60CD808F
P -1950 6800
F 0 "C?" H -2041 6846 50  0000 R CNN
F 1 "100nF" H -2041 6755 50  0000 R CNN
...
U 1 1 60DAF2EB
P -1300 3650
F 0 "C?" H -1212 3696 50  0000 L CNN
F 1 "22µF" H -1212 3605 50  0000 L CNN
...
U 1 1 60DB0841
P -2000 3650
F 0 "C?" H -2088 3696 50  0000 R CNN
F 1 "10µF" H -2088 3605 50  0000 R CNN
F 2 "" H -2000 3650 50  0001 C CNN
F 3 "~" H -2000 3650 50  0001 C CNN
	1    -2000 3650
	1    0    0    -1  
$EndComp
Text Label -300 3500 2    50   ~ 0
+3.3V-EXT
Wire Wire Line
	-750 3500 -300 3500
$Comp
...
F 1 "+3.3V" H -885 3523 50  0000 C CNN
...
U 1 1 60DB232C
P -900 3500
F 0 "JP?" H -900 3613 50  0000 C CNN
F 1 "SolderJumper_3_Bridged12" H -900 3610 50  0001 C CNN
...
F 1 "+3.3V" H -1935 6823 50  0000 C CNN
...
F 1 "GND" H -1945 6777 50  0000 C CNN
...
U 1 1 61424A77
P -900 4450
F 0 "R?" H -841 4496 50  0000 L CNN
F 1 "4.7kΩ" H -841 4405 50  0000 L CNN
...
U 1 1 614F393D
P -550 4450
F 0 "R?" H -491 4496 50  0000 L CNN
F 1 "4.7kΩ" H -491 4405 50  0000 L CNN
...
F 1 "+5V" H -885 4473 50  0000 C CNN
...
U 1 1 6157332A
P -550 4300
F 0 "#PWR?" H -550 4150 50  0001 C CNN
F 1 "+5V" H -535 4473 50  0000 C CNN
F 2 "" H -550 4300 50  0001 C CNN
F 3 "" H -550 4300 50  0001 C CNN
	1    -550 4300
	1    0    0    -1  
$EndComp
Text Label -50  4800 2    50   ~ 0
SCL
Wire Wire Line
	-550 4800 -50  4800
Wire Wire Line
