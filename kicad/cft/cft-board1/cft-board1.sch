...
F6 "ACP" O L 1600 9250 50 
F7 "CLK4" I L 1600 8550 50 
F8 "~DECSP" O R 2750 10150 50 
F9 "~INCSP" O R 2750 10050 50 
F10 "~DECAC" O R 2750 9650 50 
F11 "~INCAC" O R 2750 9550 50 
F12 "~READ-SP" O R 2750 9850 50 
F13 "~WRITE-SP" O R 2750 9950 50 
F14 "~WRITE-AC" O R 2750 9450 50 
F15 "~ACTION-SRU" O R 2750 9150 50 
F16 "~ACTION-CLL" O R 2750 9050 50 
F17 "~ACTION-CPL" O R 2750 8950 50 
F18 "~READ-AC" O R 2750 9350 50 
F19 "~READ-ALU-B" O R 2750 8750 50 
F20 "~READ-ALU-Y" O R 2750 8650 50 
F21 "~ALU-OP" O R 2750 8550 50 
F22 "~WRITE-ALU-B" O R 2750 8850 50 
$EndSheet
$Sheet
...
F15 "FLOUT-ROM" O R 5800 9750 50 
F16 "~SETL-ROM" O R 5800 9850 50 
F17 "~READ-ALU-Y" I L 4650 9100 50 
F18 "T34" I L 4650 9200 50 
$EndSheet
$Sheet
...
F5 "FLOUT-ROM" I L 1650 13550 50 
...
B[0..15]
Wire Wire Line
	4650 11900 4150 11900
Wire Wire Line
	4650 11750 4150 11750
Wire Wire Line
	4650 11600 4150 11600
Wire Bus Line
	4650 11450 4150 11450
Text Label 4150 11450 0    50   ~ 0
IR[0..3]
Text Label 4150 11600 0    50   ~ 0
IR4
...
IR6
Wire Wire Line
	4150 10650 4650 10650
Wire Wire Line
	4650 11050 4150 11050
Wire Wire Line
	4650 10850 4150 10850
...
BCP
Text Label 4150 10650 0    50   ~ 0
~RESET
Text Label 4150 10850 0    50   ~ 0
CLK2
...
F 0 "JP103" H 3750 9463 50  0000 C CNN
F 1 "SolderJumper_2_Bridged" H 3750 9464 50  0001 C CNN
F 2 "Jumper:SolderJumper-2_P1.3mm_Bridged_RoundedPad1.0x1.5mm" H 3750 9350 50  0001 C CNN
...
U 1 1 5DC97446
P 3600 9400
F 0 "#PWR0108" H 3600 9150 50  0001 C CNN
...
FL-OFFBOARD
Wire Wire Line
	4650 10750 4150 10750
Text Label 4150 10750 0    50   ~ 0
~RSTHOLD
...
F12 "FZ" O R 8300 2700 50 
F13 "FN" O R 8300 2800 50 
$EndSheet
$Sheet
...
F1 "irc.sch" 50
F2 "~RIER" I R 8300 4850 50 
F3 "FPD[0..7]" T R 8300 4950 50 
F4 "~RESET" I R 8300 5050 50 
F5 "~WIER" I R 8300 5150 50 
F6 "~RISR" I R 8300 5250 50 
F7 "~FPIRF" I R 8300 5350 50 
F8 "~IRQ" T R 8300 5450 50 
F9 "~FPIEN" I R 8300 5550 50 
F10 "DB[0..15]" B R 8300 5650 50 
F11 "~IRQ[0..7]" T R 8300 5750 50 
F12 "CLK2" I R 8300 5850 50 
F13 "CLK3" I L 7150 4950 50 
F14 "~IRQ0i" I L 7150 5050 50 
F15 "~IRQ1i" I L 7150 5150 50 
F16 "~IRQ2i" I L 7150 5250 50 
$EndSheet
Wire Wire Line
	8300 2700 8800 2700
...
$Sheet
S 8850 4450 1150 1800
U 61C2F29F
F0 "Bus Interface" 50
F1 "bus_interface.sch" 50
F2 "CLK3" I L 8850 4650 50 
F3 "~RESET" I L 8850 4550 50 
F4 "~WS" T L 8850 4750 50 
F5 "AB1" I L 8850 4850 50 
F6 "AB2" I L 8850 4950 50 
F7 "AB3" I L 8850 5050 50 
F8 "AB4" I L 8850 5150 50 
F9 "AB5" I L 8850 5250 50 
F10 "AB6" I L 8850 5350 50 
F11 "AB7" I L 8850 5450 50 
F12 "~SYSDEV" I L 8850 5550 50 
F13 "~T0CS" O L 8850 5650 50 
F14 "~T1CS" O L 8850 5750 50 
F15 "~RTCCS" O L 8850 5850 50 
F16 "~W" I L 8850 5950 50 
F17 "~R" I L 8850 6050 50 
F18 "~RISR" O L 8850 6150 50 
F19 "~RIER" O R 10000 4900 50 
F20 "~WIER" O R 10000 5000 50 
F21 "~RTCR" O R 10000 5100 50 
F22 "~RTCAW" O R 10000 5200 50 
F23 "~RTCW" O R 10000 5300 50 
$EndSheet
$EndSCHEMATC
