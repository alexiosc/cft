...
$EndSheet
$Sheet
S 3250 2050 1150 1650
U 5EFCF155
F0 "Skip/Branch Unit" 50
F1 "cft_sbl.sch" 50
F2 "~SKIP" O R 4400 2200 50 
F3 "FN" I L 3250 3300 50 
F4 "~SKIPEXT" T L 3250 3550 50 
F5 "FV" I L 3250 2850 50 
F6 "FL" I L 3250 3000 50 
F7 "FZ" I L 3250 3150 50 
F8 "CLK4" I L 3250 2350 50 
F9 "~RESET" I L 3250 2200 50 
F10 "COND[0..3]" I L 3250 2650 50 
F11 "IR[0..15]" I L 3250 2500 50 
F12 "CEXT1" I R 4400 2350 50 
F13 "CEXT2" I R 4400 2500 50 
F14 "CEXT3" I R 4400 2650 50 
$EndSheet
$Sheet
...
$EndSheet
$Sheet
S 4250 -3800 1150 600 
U 5D4D9B4A
F0 "Data Bus Driver" 50
F1 "cft_busdrv.sch" 50
F2 "DB[0..15]" T R 5400 -3650 50 
F3 "IBUS[0..15]" T L 4250 -3650 50 
F4 "~R" I L 4250 -3350 50 
F5 "~BUSEN" I L 4250 -3500 50 
$EndSheet
$Sheet
S -3300 -350 1150 2300
U 5E726BB8
F0 "Unit Decoders" 50
F1 "cft_unit_decoders.sch" 50
F2 "RUNIT[0..3]" I L -3300 300 50 
F3 "CLK1" I L -3300 -50 50 
F4 "~R1" O R -2150 -200 50 
F5 "~RAGL" O R -2150 -100 50 
F6 "~READ-PC" O R -2150 0   50 
F7 "~READ-DR" O R -2150 100 50 
F8 "~RAC" O R -2150 200 50 
F9 "~R6" O R -2150 300 50 
F10 "~R7" O R -2150 400 50 
F11 "~µCE" I L -3300 600 50 
F12 "WUNIT[0..2]" I L -3300 450 50 
F13 "~RESET" I L -3300 -200 50 
F14 "CLK3" I L -3300 100 50 
F15 "~W1" I R -2150 600 50 
F16 "~WRITE-AR" I R -2150 700 50 
F17 "~WRITE-PC" I R -2150 800 50 
F18 "~WIR" I R -2150 900 50 
F19 "~WRITE-DR" I R -2150 1000 50 
F20 "~WRITE-AC" I R -2150 1100 50 
F21 "~WALU" I R -2150 1200 50 
F22 "~STPDR" I L -3300 1400 50 
F23 "~DEC" I L -3300 1700 50 
F24 "~STPAC" I L -3300 1550 50 
F25 "RESET" O R -2150 1400 50 
F26 "~ACTION-DECDR" O R -2150 1500 50 
F27 "~ACTION-INCDR" O R -2150 1600 50 
F28 "~ACTION-DECAC" O R -2150 1700 50 
F29 "~ACTION-INCAC" O R -2150 1800 50 
$EndSheet
$Sheet
...
Wire Notes Line
	9150 -6350 9150 -1800
$Sheet
S 6300 -3700 1150 1300
U 5D69F3FD
F0 "Flag Unit" 50
F1 "flag_unit.sch" 50
F2 "FPO[0..7]" T R 7450 -2550 50 
F3 "IBUS[8..15]" T R 7450 -3550 50 
F4 "~FPFLAGS" I L 6300 -2550 50 
F5 "~ACTION-CPL" O R 7450 -3400 50 
F6 "~ACTION-CLL" O R 7450 -3300 50 
F7 "~ACTION-STI" O R 7450 -3200 50 
F8 "~ACTION-CLI" O R 7450 -3100 50 
F9 "~ACTION-CLA" O R 7450 -3000 50 
F10 "WADDR[0..4]" I L 6300 -3550 50 
F11 "RADDR[0..4]" I L 6300 -3400 50 
F12 "ACTION[0..3]" I L 6300 -3250 50 
F13 "FI" I L 6300 -3100 50 
F14 "FV" I L 6300 -3000 50 
F15 "FL" I L 6300 -2900 50 
F16 "FZ" I L 6300 -2800 50 
F17 "FN" I L 6300 -2700 50 
F18 "~FLAGWE" O R 7450 -2700 50 
$EndSheet
$Sheet
S 4250 -6850 1150 1500
U 5D46B22D
F0 "Wait States & Write Strobes" 50
F1 "cft_ws_busen.sch" 50
F2 "WSTB" I L 4250 -6100 50 
F3 "~RESET" I L 4250 -6700 50 
F4 "CLK3" I L 4250 -6400 50 
F5 "~T34" I L 4250 -6250 50 
F6 "~MEM" I L 4250 -5950 50 
F7 "~IO" I L 4250 -5800 50 
F8 "~HALT" I L 4250 -6550 50 
F9 "~WEN" I L 4250 -5650 50 
F10 "~WS" I L 4250 -5500 50 
F11 "~BUSEN" O R 5400 -6700 50 
F12 "~W" T R 5400 -6550 50 
$EndSheet
...
$EndSheet
$Sheet
S 4950 2250 1150 1800
U 5DB25C41
F0 "Action Decoders" 50
F1 "cft_action_decoder.sch" 50
F2 "ACTION[0..3]" I L 4950 2400 50 
F3 "~ACTION-CPL" T R 6100 2400 50 
F4 "~ACTION-CLL" T R 6100 2500 50 
F5 "~ACTION-STI" T R 6100 2600 50 
F6 "~ACTION-CLI" T R 6100 2700 50 
F7 "~ACTION-CLA" T R 6100 2800 50 
F8 "~ACTION6" T R 6100 2900 50 
F9 "~ACTION-SRU" T R 6100 3000 50 
F10 "~ACTION-INCPC" T R 6100 3200 50 
F11 "~ACTION-INCDR" T R 6100 3300 50 
F12 "~ACTION-DECDR" T R 6100 3400 50 
F13 "WSTB" I L 4950 2500 50 
F14 "~ACTION-INCAC" T R 6100 3500 50 
F15 "~ACTION-DECAC" T R 6100 3600 50 
F16 "~ACTION-INCSP" T R 6100 3700 50 
F17 "~ACTION-DECSP" T R 6100 3800 50 
F18 "~ACTION15" T R 6100 3900 50 
F19 "~µCE" I L 4950 2600 50 
$EndSheet
$Sheet
...
F4 "IBUS[0..15]" T L 4250 -2600 50 
F5 "~WRITE-AR" I L 4250 -2450 50 
F6 "AB[0..23]" O R 5400 -2650 50 
F7 "AEXT[0..7]" I L 4250 -2700 50 
F8 "~SYSDEV" O R 5400 -2550 50 
F9 "~IODEV1XX" O R 5400 -2450 50 
F10 "~IODEV2XX" O R 5400 -2350 50 
F11 "~IODEV3XX" O R 5400 -2250 50 
F12 "~FPAEXT" I L 4250 -2050 50 
F13 "FPD[0..7]" T R 5400 -2050 50 
$EndSheet
$Comp
L alexios:conn_2x82_ab SLOT101
U 1 1 5D38F4D9
P 13350 2000
F 0 "SLOT101" H 13400 3017 50  0000 C CNN
...
U 2 1 5D396164
P 15250 2000
F 0 "SLOT101" H 15300 3017 50  0000 C CNN
...
$Comp
L alexios:CFT-2019-Bus P101
U 1 1 5D3829BF
P 18100 2100
F 0 "P101" H 18100 2267 50  0000 C CNN
...
U 2 1 5D382B6D
P 19550 2100
F 0 "P101" H 19550 2267 50  0000 C CNN
...
U 3 1 5D388A11
P 22500 3150
F 0 "P101" H 22500 3317 50  0000 C CNN
...
U 4 1 5D388A98
P 22450 2050
F 0 "P101" H 22450 2217 50  0000 C CNN
...
Verilog
Text Notes 150  -6000 0    118  ~ 24
REG Board
Wire Notes Line
	3150 -1800 3150 -5900
Text Notes 4600 -2150 0    70   ~ 14
Verilog
Text Notes 3950 3600 0    70   ~ 14
Verilog
$EndSCHEMATC
