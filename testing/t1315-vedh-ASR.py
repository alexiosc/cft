...
def calc_ASR(x, d):
    if x & 0x8000:
        return ((x >> d) & 0xffff) | ((0xffff << (16 - d)) & 0xffff)
    return (x >> d) & 0xffff


def test_calc_ASR():
    """Test the calculation function."""
    assert calc_ASR(0x0000, 0) == 0x0000
    assert calc_ASR(0x1111, 4) == 0x0111
    assert calc_ASR(0x4321, 1) == 0x2190
    assert calc_ASR(0x4321, 2) == 0x10c8
    assert calc_ASR(0x4321, 8) == 0x0043

    assert calc_ASR(0x8642, 1) == 0xc321
    assert calc_ASR(0x8642, 2) == 0xe190
    assert calc_ASR(0x8642, 8) == 0xff86
    assert calc_ASR(0x8642, 9) == 0xffc3
    assert calc_ASR(0x8642, 12) == 0xfff8

    assert calc_ASR(0xffff, 1) == 0xffff
    assert calc_ASR(0xffff, 2) == 0xffff
    assert calc_ASR(0xffff, 3) == 0xffff
    assert calc_ASR(0xffff, 4) == 0xffff
    assert calc_ASR(0xffff, 8) == 0xffff
    assert calc_ASR(0xffff, 16) == 0xffff
